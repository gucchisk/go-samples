...
func init() {
	...
	rootCmd.PersistentFlags().BoolVarP(&logFlag, "verbose", "v", false, "Output log flag")
	
	rootCmd.PersistentFlags().StringVarP(&hostname, "hostname", "h", "", "hostname replaced for macos")
...
func initialize() {
	...
	// 	logger.Printf("%s", viper.Get("hostname"))
	// }
}
